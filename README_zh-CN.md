...
[English](https://github.com/i18n-pro/react/tree/v2.0.0#readme) | 简体中文
...
* 当前库
   * [快速上手](https://github.com/i18n-pro/react/blob/v2.0.0/docs/dist/USAGE_zh-CN.md)
   * [API](https://github.com/i18n-pro/react/blob/v2.0.0/docs/dist/API_zh-CN.md)
   * [更新日志](https://github.com/i18n-pro/react/blob/v2.0.0/docs/dist/CHANGELOG_zh-CN.md)
* i18n-pro
