...
<details >
  ...
  &emsp;&emsp;&emsp;&emsp;[接入 `I18nProvider` 和 `useI18n` ，并用 `t` 包裹文案](#接入-i18nprovider-和-usei18n-并用-t-包裹文案)<br/>
...
### 接入 `I18nProvider` 和 `useI18n` ，并用 `t` 包裹文案
...
## 8. Demo
真实代码示例可参考 `README` 文档中的 [Live Demo](https://github.com/i18n-pro/react/blob/v2.0.0-alpha.3/README_zh-CN.md#live-demo) 